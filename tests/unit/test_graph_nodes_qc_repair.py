...
async def test_with_no_signal_the_shot_is_accepted_unconditionally() -> None:
...
async def test_a_forced_repair_signal_sends_the_shot_back_to_pending() -> None:
...
async def test_the_signal_is_consumed_once_and_does_not_affect_other_shots() -> None:
...
async def test_the_repair_cap_is_respected() -> None:
